...
<head>
    ...
    <style>
      ...
      .delete .d-filewriter{position:relative;height: 200px;width: 400px;background: #908f8f;}
        .delete .d-filewriter .d-p{margin-left: 1px;margin-top: 1px;padding-top: 1px;
