  ...
  <div class="body">
    <div class="b_box">
      <div class="b_info">
        <p>
          <span>用户名：</span>
          <input  type="text" class="b_text" name="username" onkeyup="value=value.replace(/[\W_]/g,'') " onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d_]/g,''))" />
        </p>
        <p>
          <span>密码：</span>
