  ...
  <div class="body">
    <div class="b_box">
      <div class="b_info">
        <p>
          <span>用户名：</span>
          <input  type="text" class="b_text" name="username" onkeyup="this.value=this.value.replace(/[^\w]/g,'')" onpaste="this.value=this.value.replace(/[^\w]/g,'')" placeholder="请输入6-20位数字，字母或下划线"/>
        </p>
        <p>
          <span>密码：</span>
