...
<head>
  ...
  <style>
    *{margin:0;padding:0}
    ...
    .head .h-uplode{width:400px;height:240px;
    ...
    .head .h-uplode .h-login{width: 100px;height: 20px;margin-left: 80px;}
  </style>
</head>
<body>
  <form action="login4" method="post" enctype="multipart/form-data">
    <div class="head">
      <div class="h-uplode">
          ...
          <p>
            <input type="submit" value="登录" name="login" class="h-login"/>
          </p>
          <p>
