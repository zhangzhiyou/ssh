...
<head>
  ...
  <style type="text/css">
    *{margin: 0;padding: 0}
    ...
    .b_box .b_info{width: 350px;height: 310px;
      position:absolute;top:0px;left: 0px}

    .b_box .b_info p {width: 350px;height: 40px;
      background: #575157;border-radius: 4px ;float: left;
      margin:10px;
    }

     .b_box .b_info p span{width:80px ;
      height:40px;line-height:40px;font-size:16px;padding-left: 5px;
      background: #8c828c;float: left;
      border-radius: 3px }

     .b_box .b_info p input{width: 265px;
      height: 40px;background: #545353;
      font-size: 16px;border:0px;
      padding:5px;outline:none;
    }
    .b_butten .b_submit{margin-left: 40px;}
    .back{width: 350px;height: 40px;
      background: #575157;border-radius: 4px ;
     }
    .back .b_href{margin-left: 1px;margin-top: 1px;}
  </style>
</head>
<body>
  ...
  <div class="body">
    <div class="b_box">
      <div class="b_info">
        <p>
          <span>用户名：</span>
          <input  type="text" class="easyui-validatebox" required="true" name="userName" onkeyup="this.value=this.value.replace(/[^\w]/g,'')" onpaste="this.value=this.value.replace(/[^\w]/g,'')" placeholder="请输入6-20位数字，字母或下划线"/>
        </p>
        <p>
          <span>密码：</span>
        ...
        <p>
          <span>邮箱：</span>
          <input type="text" class="easyui-validatebox" required="true" validType="email" name="email" />
        </p>
        <p class="b_butten">
          <input type="submit" value="提交" class="b_submit"/>
        </p>

            <p class="b_href" style="font-size: 20px; width: 241px;padding-left: 110px;">
             <a href="Userlogin.jsp">返回登录页面</a>
            </p>
            <p style="font-size: 18px; width:254px; margin-left: 10px;padding-left: 96px">
              <tr>
                    <td width="40%"></td>
