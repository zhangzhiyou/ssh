...
<head>
  ...
  <style>
    *{margin:0;padding:0}
    ...
    .head .h-uplode .h-down{width: 100px;height: 20px;margin-top: 1px;margin-right: 1px;padding-right: 1px;padding-top: 1px;position: relative;float: left}
    .head .h-uplode .h-delect{width: 100px;height: 20px;margin-top: 1px;margin-right: 1px;padding-top: 1px;padding-right: 1px;float: right;position: absolute}
