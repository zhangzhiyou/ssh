...
<head>
  ...
  <style>
    *{margin:0;padding:0}
    ...
    .head .h-uplode  .h-prompt{width:200px;height: 20px;float:right;margin-top: 6px;margin-left: 1px;
        font-size:10px;}
    .head .h-uplode .h-jump .h-login{width: 100px;height: 20px;padding-left: 1px;padding-top: 1px;margin-top: 1px;margin-left: 100px;font-size: 10px;}

    .head .h-uplode .h-jump .h-down{width: 100px;height: 20px;float: left;margin-left: 1px;margin-top: -58px;}
    .head .h-uplode .h-jump .h-delect{width: 100px;height: 20px;margin-top: -58px;margin-right: 99px;padding-top: 1px;padding-right: 1px;float: right;}
